...
use ArrayObject;
use Dhii\Data\Object\SetDataStoreCapableTrait as TestSubject;
 ...
 * @since [*next-version*]
 */
class SetDataStoreCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Data\Object\SetDataStoreCapableTrait';
